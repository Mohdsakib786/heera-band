import imgShapeLeft3 from '../assets/b5a59300a7d1375f73bb4303dcf24ae38b1d16f3.png';
...
export function ConnectBanner() {
  ...
  return (
    <section id="connect" className="relative lg:py-[150px] px-4 overflow-hidden my-16">
     <div className="py-12 bg-gradient-to-r from-[#faf6f3] via-white to-[#faf6f3]">
      ...
      <div className="absolute left-[38px] top-[91px] w-[261px] h-[564px] opacity-40 pointer-events-none hidden lg:block">
        <div className="absolute inset-0 overflow-hidden">
          <img
            src={imgShapeLeft3}
            alt=""
            className="absolute w-full h-[156.74%] top-[-32.27%] left-0 max-w-none"
          />
        </div>
      ...
      <div className="container mx-auto flex flex-col gap-8 lg:gap-10 items-center text-center relative z-10">
        ...
        <button
          ...
          className="bg-[#968969] px-10 py-5 text-[#faf6f3] font-medium uppercase hover:bg-[#7a6d54] transition-colors" data-aos="fade-up"
        >
          Get in touch
        </button>
      </div>
