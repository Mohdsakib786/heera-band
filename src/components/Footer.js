...
function Footer() {
    ...
    return (<footer id="footer" className="bg-white py-12 lg:py-12 pb-0 px-4 lg:px-12 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2 font-['Lato'] text-[#505050]">
              <button onClick={function () { return scrollToSection('home'); }} className="text-left hover:text-[#968969] transition-colors">
                Home
              </button>
              <button onClick={function () { return scrollToSection('story'); }} className="text-left hover:text-[#968969] transition-colors">
                About
              </button>
              <button onClick={function () { return scrollToSection('services'); }} className="text-left hover:text-[#968969] transition-colors">
                Services
              </button>
              <button onClick={function () { return scrollToSection('gallery'); }} className="text-left hover:text-[#968969] transition-colors">
                Our Gallery
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-6">
              <div className="bg-[#faf6f3] px-5 py-4">
                <input type="email" placeholder="Drop your mail.." className="bg-transparent text-base text-[#505050]/60 w-full outline-none"/>
              </div>
              <div className="flex flex-col gap-4">
                <a href="tel:+919876543210" className="flex items-center gap-3 text-black hover:text-[#968969] transition-colors">
                  <lucide_react_1.Phone size={20}/>
                  <span>+91 98765 43210</span>
                </a>
                <a href="mailto:info@Herraband.com" className="flex items-center gap-3 text-black hover:text-[#968969] transition-colors">
