...
exports.Story = Story;
var _18579741b0ceb25b48267224f946714601f6c255_png_1 = require("../assets/18579741b0ceb25b48267224f946714601f6c255.png");
function Story() {
    ...
    return (<section id="story" className="relative bg-[#faf6f3] h-[864px]">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img src={_18579741b0ceb25b48267224f946714601f6c255_png_1.default} alt="" className="w-full h-[146.21%] object-cover absolute top-[-10.26%] left-0"/>
      </div>
      <div className="container mx-auto px-4 lg:px-12 relative h-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 h-full items-end">
          ...
          <div className="bg-[#faf6f3] p-8 lg:p-[60px] flex flex-col gap-8 lg:gap-[60px] mb-0 lg:w-[606px] lg:ml-auto">
            ...
            <button onClick={function () { return scrollToSection('home'); }} className="bg-[#968969] px-10 py-5 text-[#faf6f3] font-medium uppercase w-fit hover:bg-[#7a6d54] transition-colors" data-aos="fade-up">
              Know More
            </button>
          </div>
        </div>
